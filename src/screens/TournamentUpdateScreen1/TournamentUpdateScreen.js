...
const TournamentUpdateScreen = () => {
    const header = 'Tournament Updates'
    const header1 = ''
                    ...
                    renderItem={({ item }) => {
                        return (
                            <View style={{ height: 125, width: 340, backgroundColor: "#82469C", borderRadius: 30, marginBottom: 10 }}>
                                ...
                                <View style={{ alignItems: "center" }}>
                                    <View style={{ position: "absolute", backgroundColor: "#522F91", height: 25, width: 130, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, }}>
                                        <Text style={{ marginTop: 5, marginLeft: 15, position: "absolute", fontSize: 10, color: "white" }}>{item.team1} vs {item.team2}</Text>
                                    </View>
                                    <View style={{ position: "absolute", backgroundColor: "#522F91", marginTop: 100, height: 25, width: 89, borderTopLeftRadius: 10, borderTopRightRadius: 10 }}>
                                        <Text style={{ textAlign: "center", fontSize: 10, color: "white", position: "absolute", marginLeft: 15, marginTop: 5 }}>{item.ReamainingTime}</Text>
                                    </View>
                                </View>
                            </View>
                        )
    ...
    return (
        <View style={{ flex: 1, backgroundColor: "#D5D6D7" }}>
            ...
            <View style={{ height: 20, width: "100%", }}>
                <Text style={{ position: "absolute", marginTop: 0, marginLeft: 50, fontSize: 14, fontWeight: "bold" }}>Upcoming Tournament    </Text>
            </View>
            <View style={styles.UpcomingTournamentStyle}>
                {PlayersData()}
            </View>
        </View>
    )
...
export default TournamentUpdateScreen
